                                                ...
                                                @if($data->count() > 0)
                                                    ...
                                                    @foreach ($data as $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center notPrint">
                                                                @if($item->photo)
                                                                    <img class="mb-1" src="{{ asset('attachments/product/'.$item->photo) }}" alt="{{ $item->photo }}" height="50" width="70">
                                                                    <br>
                                                                    <a class="btn btn-outline-success btn-sm" href="{{ route('show_file',['product',$item->photo]) }}" role="button" target="_blank"><i class="fas fa-eye"></i></a>
                                                                    <a class="btn btn-outline-info btn-sm" href="{{ route('download_file',['product',$item->photo]) }}" role="button" target="_blank"><i class="fas fa-download"></i></a>
                                                                @endif
                                                            </td>
    ...
    <script>
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status == false) {
                            ...
                            $('#preview_image').attr('src', '/attachments/product/' + response.data.photo);
            ...
            $(document).on('click', '.updateBtn', function (e) {
                ...
                formData.append('details', $('#update_details').val());
